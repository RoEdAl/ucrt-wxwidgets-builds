...
SET(_COMMON_GCC_FLAGS "-ffunction-sections -fdata-sections -fdiagnostics-plain-output \"-ffile-prefix-map=${MINGW_DIR}=./gcc\"")
SET(_COMMON_LINKER_FLAGS "-Wl,--gc-sections -fdiagnostics-plain-output -Wl,-allow-multiple-definition")
SET(CMAKE_C_FLAGS_INIT "${_COMMON_GCC_FLAGS}")
SET(CMAKE_CXX_FLAGS_INIT "${_COMMON_GCC_FLAGS}")
